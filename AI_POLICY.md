...
The `go-holidays` project has strict rules for AI usage:
...
This policy is adapted from the [Ruby `holidays` gem's AI Usage Policy](https://github.com/holidays/holidays/blob/master/AI_POLICY.md),
itself heavily inspired by the [Ghostty AI Usage Policy](https://github.com/ghostty-org/ghostty/blob/main/AI_POLICY.md).
